...
<html>
  <head>
      ...
      <link rel="stylesheet" href="{{asset('plugins/adminlte/plugins/timepicker/bootstrap-timepicker.min.css')}}">
      <!-- Select2 -->
      ...
      <!-- fullCalendar -->
      <link rel="stylesheet" href="{{asset('plugins/adminlte/bower_components/fullcalendar/dist/fullcalendar.min.css')}}">
      <link rel="stylesheet" href="{{asset('plugins/adminlte/bower_components/fullcalendar/dist/fullcalendar.print.min.css')}}" media="print">
       <!-- DataTables -->
      <link rel="stylesheet" href="{{asset('plugins/adminlte/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
      <!-- Theme style -->
      ...
      <!-- Morris chart -->
      <link rel="stylesheet" href="{{asset('plugins/adminlte/bower_components/morris.js/morris.css')}}">
      <!-- jvectormap -->
      ...
      <!-- Daterange picker -->
      <link rel="stylesheet" href="{{asset('plugins/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
      <!-- Google Font -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <nav class="navbar navbar-static-top" style="background-color: #000000;">
              ...
              <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                      ...
                      @include('dashboard/partial/useraccount')
      ...
      <div id="divGeneralContainer"></div>
        <!-- Control Sidebar -->
        @include('dashboard/partial/controlsidebar')
      </div>
      <!-- jQuery UI 1.11.4 -->
      <script src="{{asset('plugins/adminlte/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
      ...
      <!-- DataTables -->
      <script src="{{asset('plugins/adminlte/bower_components/datatables.net/js/jquery.dataTables.min.js')}}"></script>
      <script src="{{asset('plugins/adminlte/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')}}"></script>
      <!-- Morris.js charts -->
      <script src="{{asset('plugins/adminlte/bower_components/raphael/raphael.min.js')}}"></script>
      <script src="{{asset('plugins/adminlte/bower_components/morris.js/morris.min.js')}}"></script>
      <!-- Sparkline -->
      <script src="{{asset('plugins/adminlte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
      <!-- jvectormap -->
      ...
      <!-- jQuery Knob Chart -->
      <script src="{{asset('plugins/adminlte/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
      <!-- daterangepicker -->
      <script src="{{asset('plugins/adminlte/bower_components/moment/min/moment.min.js')}}"></script>
      <script src="{{asset('plugins/adminlte/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
      <!-- datepicker -->
      <script src="{{asset('plugins/adminlte/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
      <!-- datepicker en español -->
      <script src="{{asset('plugins/adminlte/bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.es.min.js')}}"></script>
      <!-- bootstrap time picker -->
      <script src="{{asset('plugins/adminlte/plugins/timepicker/bootstrap-timepicker.min.js')}}"></script>
      <!-- Slimscroll -->
      ...
      <!-- fullCalendar -->
      <script src="{{asset('plugins/adminlte/bower_components/moment/moment.js')}}"></script>
      <script src="{{asset('plugins/adminlte/bower_components/fullcalendar/dist/fullcalendar.min.js')}}"></script>
      <!-- fullCalendar es español -->
      <script src="{{asset('plugins/adminlte/bower_components/fullcalendar/dist/locale/es.js')}}"></script>
