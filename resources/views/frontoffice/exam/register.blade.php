...
@section('title', 'Registrar evaluación')
@section('generalBody')
<div class="nav-tabs-custom">
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1-1">
            <form id="frmRegisterExam" action="{{url('examen/registrar')}}" method="post" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-12 text-right">
                        ...
                        <input type="button" class="btn btn-primary" value="Registrar Evaluación" onclick="sendRegisterExam();">
                    </div>
                </div>
...
<script src="{{asset('assets/frontoffice/viewResources/exam/register.js?x='.env('CACHE_LAST_UPDATE'))}}"></script>
@endsection
