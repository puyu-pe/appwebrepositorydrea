                            ...
                            <div class="it-category-4-item text-center">
                                ...
                                <div class="it-category-4-content">
                                    <h4 class="it-category-4-title">
                                        <a href="{{url('tipoexamen/'.$value->acronymTypeExam.'/1')}}"> {{$value->nameTypeExam}}</a>
                                    </h4>
                ...
                <div class="row">
                        ...
                        <div class="it-course-item">
                            <div class="it-course-thumb mb-20 p-relative">
                                <a href="course-details.html"><img
                                            src="{{asset('assets/frontoffice/img/course/course-1-1.jpg')}}" alt=""></a>
                            ...
                            <div class="it-course-content">
                                ...
                                <h4 class="it-course-title pb-5"><a href="course-details.html">Evaluación ERA Callao Matemática 6° Primaria</a></h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="it-course-item">
                            <div class="it-course-thumb mb-20 p-relative">
                                <a href="course-details.html"><img
                                            src="{{asset('assets/frontoffice/img/course/course-1-2.jpg')}}" alt=""></a>
                                <div class="it-course-thumb-text">
                                    <span>ECE</span>
                                </div>
                            </div>
                            <div class="it-course-content">
                                ...
                                <h4 class="it-course-title pb-5"><a href="course-details.html">Evaluación ECE Matemática 5° Primaria</a></h4>
                                <div class="it-course-info pb-15 mb-25 d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="it-course-item">
                            <div class="it-course-thumb mb-20 p-relative">
                                <a href="course-details.html"><img
                                            src="{{asset('assets/frontoffice/img/course/course-1-3.jpg')}}" alt=""></a>
                                <div class="it-course-thumb-text">
                                    <span>ERA</span>
                                </div>
                            </div>
                            <div class="it-course-content">
                                ...
                                <h4 class="it-course-title pb-5"><a href="course-details.html">2° Evaluación ERA Apurímac Comunicación 1° Primaria</a></h4>
                                <div class="it-course-info pb-15 mb-25 d-flex justify-content-between">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-7 col-md-9 col-sm-9">
                        <div class="it-video-content">
                            ...
                            <p>¡Mantente al tanto de las últimas evaluaciones subidas y respondidas en nuestro repositorio! </p>
                ...
                <div class="row">
                    ...
                    <img src="{{asset('assets/frontoffice/img/work/work-1.svg')}}" alt="">
                            ...
                            <div class="it-work-content">
                                ...
                                <p>Acceder de manera organizada, a la amplia gama de evaluaciones, con la posibilidad de filtrar y buscar según sus necesidades</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                    ...
                    <img src="{{asset('assets/frontoffice/img/work/work-1.svg')}}" alt="">
                            ...
                            <div class="it-work-content">
                                <h4 class="it-work-title-sm"><a href="service-details.html">Respuestas de Evaluaciones</a></h4>
                                <p>Los usuarios pueden registrar sus respuestas a las evaluaciones y hacer públicas las respuestas para compartir y mejorar</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                    ...
                    <img src="{{asset('assets/frontoffice/img/work/work-1.svg')}}" alt="">
                            ...
                            <div class="it-work-content">
                                <h4 class="it-work-title-sm"><a href="service-details.html">Interacción y Colaboración</a></h4>
                                <p>Comentar las respuestas y compartir estrategias de resolución permitiendo retroalimentación constructiva</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="swiper-container it-testimonial-3-active">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="it-testimonial-3-item">
                                                <div class="it-testimonial-3-content">
                                                    <p>¡Estoy realmente impresionada con el servicio que ofrece este sitio web!
                                                        Como estudiante de secundaria, siempre he luchado con la preparación para las evaluaciones,
                                                        pero este repositorio de evaluaciones ha hecho que sea mucho más fácil para mí practicar y mejorar.
                                                        La función de registro de respuestas me ha ayudado a identificar mis fortalezas y debilidades.</p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="it-testimonial-3-item">
                                                <div class="it-testimonial-3-content">
                                                    <p>Como docente de matemáticas, siempre estoy buscando maneras de apoyar a mis estudiantes en su preparación
                                                        para las evaluaciones. Este repositorio de evaluaciones ha sido una herramienta invaluable en mi clase.
                                                        La variedad de evaluaciones disponibles y la capacidad de personalizar las preferencias de los estudiantes
                                                        han hecho que sea mucho más fácil para ellos practicar y mejorar sus habilidades.</p>
                                                    <div class="it-testimonial-3-author-box d-flex align-items-center">
                                                        <div class="it-testimonial-3-avata">
                                                            <img
                                            ...
                                            <div class="it-testimonial-3-item">
                                                <div class="it-testimonial-3-content">
                                                    <p>Siempre estoy buscando formas de mejorar mi rendimiento académico.
                                                        Este repositorio de evaluaciones ha sido una verdadera bendición para mí. La interfaz fácil de usar
                                                        y la amplia selección de evaluaciones disponibles han hecho que sea mucho más fácil para mí practicar
                                                        y prepararme para mis exámenes. Además, la posibilidad de interactuar con otros estudiantes y ver sus
                                                        respuestas me ha ayudado a aprender de diferentes enfoques y estrategias de resolución</p>
                                                    <div class="it-testimonial-3-author-box d-flex align-items-center">
                                                        <div class="it-testimonial-3-avata">
                                                            <img
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    Contact With US
                                ...
                                <h2 class="it-section-title-3">Registra tus datos para generar tu solicitud de inscripción</h2>
                            </div>
                            <div class="it-contact-text pb-15">
                                <p>La inscripción en la web es sencillo, completa el formulario con tus datos personales y de contacto,
                                    indicando si es docente o estudiante, Una vez aprobado serás notificado por correo.
                                    Los usuarios obtienen acceso para registrar respuestas y participar en la comunidad educativa</p>
                            </div>
                        </div>
                    </div>
