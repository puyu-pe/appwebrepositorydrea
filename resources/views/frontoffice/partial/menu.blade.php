        ...
        <div class="it-header-wrap p-relative">
            <div class="row align-items-center">
                ...
                <div class="it-header-2-logo">
                    <a href="{{url('/')}}"><img src="{{asset('img/logodrea.png')}}" alt="logo"></a>
                </div>
                </div>
                ...
                <div class="it-header-2-main-menu">
                    <nav class="it-menu-content">
                        <ul>
                            ...
                            <li id="mTypeExam" class="has-dropdown {{Session::get('menu')=='mTypeExam' ? 'active' : ''}}">
                            ...
                            @if (stristr(Session::get('roleUser'), 'Administrador')==true || stristr(Session::get('roleUser'), 'Registrador')==true)
                                <li id="mModuleExam" class="has-dropdown {{Session::get('menu')=='mModuleExam' ? 'active' : ''}}">
                                    <a href="#">Opciones para pruebas</a>
                                    <ul class="it-submenu submenu">
                                        <li id="mRegisterExam" class="{{Session::get('subMenu')=='mRegisterExam' ? 'active' : ''}}"><a href="{{url('examen/registrar')}}">Registrar una prueba</a></li>
                                    </ul>
                                </li>
                            @endif
