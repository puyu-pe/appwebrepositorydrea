...
<head>
    ...
    <link
        ...
        rel="stylesheet"/>
    <title>Respuesta a consulta</title>
    <!--[if !mso]><!-- -->
    <style>
        @media all {
            /* cyrillic-ext */
    ...
    <style>
        @media (max-width: 620px) {
            ...
            td.pc-w620-spacing-0-0-40-0, th.pc-w620-spacing-0-0-40-0 {
                margin: 0 !important;
...
<body class="pc-font-alt"
      ...
      bgcolor="#f4f4f4">
<table class="pc-project-body" style="table-layout: fixed;min-width: 600px;background-color:#f4f4f4;" bgcolor="#f4f4f4"
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td valign="top"
                                                            ...
                                                            style="padding: 40px 40px 60px 40px;border-radius: 0px;background-color: #ffffff;"
                                                            bgcolor="#ffffff">
                                                            <table width="100%" border="0" cellpadding="0"
                                                                   cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td class="pc-w620-spacing-0-0-40-0" align="center"
                                                                        valign="top" style="padding: 0px 0px 60px 0px;">
                                                                        <img
                                                                            src="https://cloudfilesdm.com/postcards/image-1711061280430.png"
                                                                            class="" width="301" height="69" alt=""
                                                                            style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:301px;height: auto;max-width: 100%;"/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <table width="100%" border="0" cellpadding="0"
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top"
                                                                                    ...
                                                                                    align="center"
                                                                                    style="mso-line-height: exactly;line-height: 128%;letter-spacing: -0.6px;font-family: Fira Sans, Arial, Helvetica, sans-serif;font-size: 36px;font-weight: 800;color: #1b1b1b;text-align: center;text-align-last: center;font-variant-ligatures: normal;">
                                                                                    <div><span>Hola {{$completeNameContact}},<br> Tenemos la respuesta a tu consulta</span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                            ...
                                                            <table width="100%" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top"
                                                                        ...
                                                                        <img
                                                                            src="https://cloudfilesdm.com/postcards/image-1711061368222.png"
                                                                            class="" width="126" height="126" alt=""
                                                                            style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:126px;height: auto;max-width: 100%;"/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <table width="100%" border="0" cellpadding="0"
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top"
                                                                                    ...
                                                                                    align="left"
                                                                                    style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Fira Sans, Arial, Helvetica, sans-serif;font-size: 14px;font-weight: 300;color: #282828;text-align: left;text-align-last: left;font-variant-ligatures: normal;">
                                                                                    <div>
