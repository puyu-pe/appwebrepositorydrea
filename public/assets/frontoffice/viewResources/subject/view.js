...
function _getUrlSearch() {
    ...
    const code = $('#hdCodeSubject').val();
    return `${window.location.origin}/curso/${code}/1?searchParameter=${searchParameter}&type=${typeExam}&grade=${grade}&subject=${subject}&year=${year}`;
}
