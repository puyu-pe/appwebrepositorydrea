...
$(function()
{
    $('#frmRegisterExam').formValidation(objectValidate(
    {
        txtDescriptionExam:
        {
            validators:
...
function sendRegisterExam()
{
    var isValid=null;

    $('#frmRegisterExam').data('formValidation').resetForm();
    $('#frmRegisterExam').data('formValidation').validate();

    isValid=$('#frmRegisterExam').data('formValidation').isValid();
    ...
    confirmDialogSend('frmRegisterExam');
}
